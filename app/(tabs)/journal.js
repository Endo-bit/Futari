...
const styles = StyleSheet.create({
  ...
  calTitle: { fontFamily: fonts.scriptSemiBold, fontSize: 24, lineHeight: 30, color: C.ink },
  ...
  sdTitle: { fontFamily: fonts.scriptSemiBold, fontSize: 23, lineHeight: 29, color: C.ink },
