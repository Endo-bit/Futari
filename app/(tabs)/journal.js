...
const styles = StyleSheet.create({
  ...
  calTitle: { fontFamily: fonts.scriptSemiBold, fontSize: 24, lineHeight: 36, paddingVertical: 3, color: C.ink },
  ...
  sdTitle: { fontFamily: fonts.scriptSemiBold, fontSize: 23, lineHeight: 34, paddingVertical: 3, color: C.ink },
