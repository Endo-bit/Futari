...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: fonts.scriptBold, fontSize: 32, lineHeight: 40, color: C.ink, marginBottom: 6 },
  ...
  priceLabel: { fontFamily: fonts.scriptBold, fontSize: 30, lineHeight: 38, color: C.ink },
